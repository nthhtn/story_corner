		...
		return (
			<article id="post-3000"
				...
				<div className="featured-image">
					<a href="https://gocnhoannie.com/nghi-ngoi-cung-la-mot-phan-cua-qua-trinh/">
						...
						<img width="1000" height="627"
							src="https://gocnhoannie.com/wp-content/uploads/2021/09/Nghi-ngoi-cung-la-mot-phan-cua-qua-trinh-e1631717338462-1000x627.jpg"
				...
				<header className="entry-header">
					...
					<h2 className="entry-title"><a
						...
						rel="bookmark">Nghỉ ngơi cũng là một phần của quá trình</a></h2>
					<div className="entry-meta">
						<span className="posted-on">Posted on <a
							href="https://gocnhoannie.com/nghi-ngoi-cung-la-mot-phan-cua-qua-trinh/"
							rel="bookmark"><time className="entry-date published"
								dateTime="2021-09-15T21:41:37+07:00">Tháng Chín 15, 2021</time><time
									className="updated" dateTime="2021-09-17T09:05:02+07:00">Tháng Chín 17,
								2021</time></a></span><span className="byline"> by <span
									className="author vcard"><a className="url fn n"
										href="https://gocnhoannie.com/author/gocnhoannie/">Annie</a></span></span>
					</div>
				</header>
...
export default class ArticleInCategory extends Component {
					...
					<div id="primary" className="content-area">
						<main id="main" className="site-main" role="main">
							...
							<header className="page-header">
								<h1 className="page-title">Danh mục: <span>Điện ảnh</span></h1>
							</header>

							<ArticleItem />

							<div className="separator"><svg className="pencil-sharpener" version="1.1" x="0px" y="0px"
